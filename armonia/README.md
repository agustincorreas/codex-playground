...
| **Chord pads** | Ocho memorias debajo de la grilla: clic corto toca el acorde guardado (tipo, modificadores, voicing y octava); mantener medio segundo guarda el acorde actual. El **dado** (⚄) al lado del Voicing Dial toca un acorde al azar (dentro de la tonalidad si Key Mode está activo). |
| **Strum plate** | Franja sobre el teclado: pasá el dedo o el mouse para rasguear las notas del acorde en dos octavas, como un Omnichord. |
| **Chord Modifiers** (fila inferior) | 6 · m7 · M7 · 9. Se combinan libremente (Cmaj9, Dm7, G13, Bø7, C6/9…). |
| **Secret chords** | Con la opción activa, un segundo botón de tipo se combina con el primero (la grilla muestra la combinación, por ejemplo "Major + Minor = Aug"): Major+Minor = aumentado (C+), Major+Sus = sus2, Major+Dim = ♭5, Minor+Sus = power chord (C5), Minor+Dim = m♭6, Sus+Dim = cuartal (7sus4). En PC: Shift + 1–4. |
...
| **Sound** | 60 presets. Un banco de 40 sonidos 80s/90s organizado por categoría (Pad: Poly Pad 84, Warm Analog, Supersaw, Glass Pad 87, Dark Pad, Choir 90s, Sweep Pad, Ambient Drone, String Machine, Trance Pad · Keys: DX E-Piano, FM Piano 80s, House Piano, Clav 80s, Digital Harpsi, Poly Pluck, Digital Vibes, Music Box, Lo-fi Keys · Brass/Lead: Poly Brass, Brass Stab, Horns 80s, Saw Lead, Square Lead 8-bit, Sync Lead, Trance Lead, 8-bit Chip · Bell: FM Bells 80s, Tubular, Crystal, Digital Marimba, FM Kalimba, Steel Drum · Vox/Strings: Vox Humana, Analog Strings, Orchestra Hit, Choir Aah 80s · Organ: Rock Organ, Cheese Organ, Accordion) más los 20 clásicos: Keys · E-Piano (FM) · Wurli · Organ · Pad · Strings · Choir (formantes) · Pluck · Guitar · Brass · Bells (FM) · Marimba · Clav · Harp · Vibes · Flute · Poly 80 · Kalimba · Glass · Dream. Cada preset define su chorus estéreo, vibrato, trémolo, transitorio y panorama por voz; la velocidad MIDI controla el brillo. Cambiar Sound afecta lo que tocás y la capa que estás grabando; las capas anteriores del loop conservan el suyo. Debajo, cuatro **macros de edición** (cut, res, atk, rel) sobre el preset elegido. |
...
| **Prog** | Progresiones de acordes por género: Pop (I–V–vi–IV) · 50s doo-wop · Rock · Blues de 12 compases con séptimas · Jazz ii–V–I · Bossa nova · Neo soul (novenas y trecenas) · Funk vamp · Reggae · Reggaetón (i–VI–III–VII) · Trap · Gospel · EDM · Synthwave · Cumbia · Bolero · Andaluza. Con Play, el instrumento cambia de acorde al tempo en la tonalidad de Key; los botones de tipo muestran cada acorde; podés cambiar Sound, Perform y bajo mientras suena, y grabarla en el loop (el largo del loop se ajusta solo). Tocar una tecla pausa la progresión hasta soltar. |
| **Key** | Transpone el teclado (la tecla de la izquierda pasa a ser la tónica elegida). Atajo: mantené apretado el encoder medio segundo y tocá una tecla: esa nota pasa a ser la tonalidad. El botón **Key mode** debajo cicla Off → Major → Minor → Dorian → Mixolydian → Lydian → Phrygian → menor armónica: en Major/Minor cualquier tecla genera el acorde diatónico de esa tonalidad y los botones de tipo pasan a ser automáticos (se ven en amarillo). Ese "Minor" es la tonalidad completa; el botón Minor de los tipos es un acorde suelto y en Key mode no se usa. |
