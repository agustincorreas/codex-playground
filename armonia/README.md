...
| **Bass** | Nivel del bajo y dos selectores: **modo** (Off · Root · Root · 5th · Walking · Octaves · Pulse 8ths · Solo) y **sonido** (Sub · Finger · Pick · Synth · 808). Los patrones siguen el reloj con Play: Root marca 1 y 3, Root · 5th alterna fundamental y quinta, Walking camina por las notas del acorde, Octaves y Pulse hacen corcheas. En **Solo** el teclado toca el bajo monofónico mientras el acorde latcheado o en loop sigue sonando. Cada capa del loop recuerda su modo y sonido de bajo. Tecla B cicla los modos. |
